...
func main() {
	...
	/*
	 1) запустить отдельную рутину которая будет давать задачи и
	 оставить мейн собирать ответы и убрать все буферы
	*/
...
1) запустить отдельную рутину которая будет давать задачи и оставить мейн собирать ответы и убрать все буферы
2) заставить мейн одновременно писать задачи и собирать ответы в обном цикле, и убрать буфер опять же

первый вариант проще, конечно
*/
func getTask(taskCHANEEL chan int) {
